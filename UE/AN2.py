...
def InitialReq():
	...
	eNBInfo = {"ID":"28193","MCC":"208","MNC":"93","TAC":"01","MsgType":"eNBConnect2AMF"}
	...
	if ret == r1.content :
        	...
        	UEConnectionInfo = {"eNBID":"28193","MsgType":"UEConnect2AMF"}
        	...
        	if ret == r2.content :
                	...
                	UEInfo = {"imsi":"208930000000002","msisdn":"32435235366","key":"8baf473f2f8fd09487cccbd7097c6862","opc":"e734f8734007d6c5ce7a0508809e7e9c","MsgType":"UEReqRigstr"}
                	...
                	if ret == r3.content :
                        	...
                        	if r4.status_code == 200:
                                	...
                                	print("[UE][INFO]   RequestProcedureTerminatedNormally!")
                                	# if ret == r5.content :
